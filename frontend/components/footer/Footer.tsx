...
export default function Footer() {
	return (
		<footer className="py-6 md:py-10 lg:py-14">
			<Container className="flex flex-col items-center justify-between gap-y-8 md:flex-row md:items-start lg:gap-y-0">
				<Link href="/" className="font-heading text-3xl uppercase">
					Bloom
				</Link>
				<div className="flex flex-col justify-center gap-x-8 gap-y-8 sm:flex-row sm:gap-x-14 md:gap-x-16">
